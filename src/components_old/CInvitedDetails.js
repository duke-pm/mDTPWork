/**
 ** Name: Custom Invited Details
 ** Author: DTP-Education
 ** CreateAt: 2021
 ** Description: Description of CInvitedDetails.js
 **/
...
function CInvitedDetails(props) {
  ...
  return (
    <View>
      ...
      <RowInfo
        icon={Icons.mailTask}
        label={checkEmpty(participant.email)}
        onPress={handleEmail}
      />
...
CInvitedDetails.propTypes = {
  participant: PropTypes.object,
};

export default React.memo(CInvitedDetails);
