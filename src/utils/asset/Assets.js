...
const Assets = {
  ...
  iconAssets: require('../../../assets/images/icon/dashboard/assets.png'),
  iconProjectManagement: require('../../../assets/images/icon/dashboard/projectManagement.png'),
  ...
  iconListApprovedHandling: require('../../../assets/images/icon/listAssetsHandling.png'),
