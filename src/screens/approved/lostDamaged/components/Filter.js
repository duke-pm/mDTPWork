        ...
        <View style={cStyles.px16}>
          <View style={[cStyles.row, cStyles.itemsCenter, cStyles.justifyBetween]}>
            <View style={styles.text_date}>
              <CText customStyles={[cStyles.pt16, cStyles.textLeft,]} label={'approved_lost_damaged:from_date'} />
            </View>
            <CInput
          ...
          <View style={[cStyles.row, cStyles.itemsCenter, cStyles.justifyBetween]}>
            <View style={styles.text_date}>
              <CText customStyles={[cStyles.pt16, cStyles.textLeft,]} label={'approved_lost_damaged:to_date'} />
            </View>
            <CInput
              containerStyle={[cStyles.justifyEnd, styles.input_date]}
              style={styles.con_input_date}
          ...
          <View style={[cStyles.row, cStyles.justifyBetween]}>
            <CCheckbox
              ...
              label={'approved_lost_damaged:damaged'}
            ...
            <CCheckbox
              style={styles.con_input_status}
              labelStyle={'textDefault pl10'}
              label={'approved_lost_damaged:lost'}
          ...
          <View style={[cStyles.row, cStyles.justifyBetween]}>
            <CCheckbox
              style={styles.con_input_status}
              labelStyle={'textDefault pl10'}
              label={'approved_lost_damaged:status_wait'}
            ...
            <CCheckbox
              style={styles.con_input_status}
              labelStyle={'textDefault pl10'}
              label={'approved_lost_damaged:status_approved'}
            ...
            <CCheckbox
              style={styles.con_input_status}
              labelStyle={'textDefault pl10'}
              label={'approved_lost_damaged:status_reject'}
          ...
          <View>
            <CCheckbox
              style={styles.con_input_status}
              labelStyle={'textDefault pl10'}
              label={'approved_lost_damaged:resolve_request'}
          ...
          <CButton
            label={'approved_lost_damaged:filter_start'}
