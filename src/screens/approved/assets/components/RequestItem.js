          ...
          <View style={[
            ...
            <View style={[cStyles.row, cStyles.itemsStart]}>
              ...
              <CText
                ...
                customLabel={t('approved_assets:title_request_item') + props.data.requestID}
              />
            </View>
          </View>
            ...
            <View style={[cStyles.flex1, cStyles.pt10]}>
              <View style={[cStyles.row, cStyles.itemsStart, cStyles.justifyBetween]}>
                <View style={[cStyles.row, cStyles.itemsStart, styles.header_left]}>
                  <CText styles={'textMeta'} label={'approved_assets:date_request'} />
                  <CText
                ...
                <View style={[cStyles.row, cStyles.itemsStart]}>
                  <CText styles={'textMeta'} label={'approved_assets:status_request'} />
              ...
              <View style={[cStyles.row, cStyles.itemsStart, cStyles.justifyBetween]}>
                <View style={[cStyles.row, cStyles.itemsStart, styles.header_left]}>
                  <CText styles={'textMeta'} label={'approved_assets:region_request'} />
                ...
                <View style={[cStyles.row, cStyles.itemsStart, cStyles.justifyEnd, styles.header_right]}>
                  <CText styles={'textMeta'} label={'approved_assets:user_request'} />
              ...
              <View style={[cStyles.row, cStyles.itemsStart, cStyles.justifyBetween]}>
                <View style={[cStyles.row, cStyles.itemsStart, styles.header_left]}>
                  <CText styles={'textMeta'} label={'approved_assets:department_request'} />
